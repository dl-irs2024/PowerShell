	...
	<Grid Margin='12'>
		...
		<ScrollViewer Grid.Row='0' VerticalScrollBarVisibility='Auto'>
			<Grid Margin='0,0,8,0'>
				...
				<CheckBox x:Name='chkDst' Grid.Row='7' Grid.Column='1' Margin='0,0,0,8' VerticalAlignment='Center' Content='Observe DST' ToolTip='Check if this timezone observes Daylight Saving Time'/>
				...
				<CheckBox x:Name='chkIsAdmin' Grid.Row='12' Grid.Column='1' Margin='0,0,0,8' VerticalAlignment='Center' Content='Is Admin (can manage reservations)' ToolTip='Check to grant admin privileges for managing reservations'/>
			</Grid>
		</ScrollViewer>
...
<Window xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation'
	...
	<DockPanel Margin='10'>
		...
		<Button x:Name='btnRefresh' Width='95' Height='30' Content='Refresh' ToolTip='Reload all users from file (discards unsaved changes)'/>
		</StackPanel>
...
$refreshUsers = {
	...
	& $setStatus ("Refreshed users from {0}" -f $script:UsersPath)
}
