...
$reservationModulePath = Join-Path $modulePath 'TrackSessions.Reservations2.psm1'

# Remove any cached version of the module
Remove-Module TrackSessions.Reservations2 -Force -ErrorAction SilentlyContinue
