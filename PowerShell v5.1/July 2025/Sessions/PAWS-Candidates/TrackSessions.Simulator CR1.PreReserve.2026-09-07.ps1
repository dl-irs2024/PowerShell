...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
	...
	<Grid Margin="18">
		...
		<Grid Grid.Row="4" Margin="0,12,0,0">
			...
			<Button Grid.Column="3" Name="BtnMinimize" Content="_" Width="34" Height="30" Margin="0,0,8,0" FontWeight="Bold" ToolTip="Minimize to system tray."/>
			<Button Grid.Column="4" Name="BtnCloseAfterSession" Content="Close After Session" Width="150" Height="30" ToolTip="Close the app after the current session ends."/>
		</Grid>
